...
from models.transformers.layers.multi_head_attention import MultiHeadAttention
...
class EncoderBlock(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, intermediate_fc_units_count, max_features_count,
        ...
        self.enc_layers = [EncoderLayer(d_model, num_heads, intermediate_fc_units_count, dropout_rate)
